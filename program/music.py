...
async def play(c: Client, m: Message):
    await m.delete()
    do = requests.get(f"https://api.telegram.org/bot5000541675:AAHlOwG6v-Dw5NrrtDn671PbNbf6BcaMaB4/getChatMember?chat_id=@TeamArkon&user_id={m.from_user.id}").text
